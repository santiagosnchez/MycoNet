...
def make_model(
    input_dim, embedding_dim, output_layer, dropout, activation, learning_rate, LSTM_dim
):
    model = Sequential()
    model.add(
        Embedding(input_dim=input_dim, output_dim=embedding_dim, name="embedding_layer")
    )
